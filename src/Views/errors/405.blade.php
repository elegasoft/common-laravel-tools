...
<head>
    ...
    <style>
        ...
        .background-color {
            background-color: rgba(25, 25, 25, .4) !important;
        }
...
<div class="content-container">
    ...
    <div class="subheader primary-text-color">
        Oops, the page you're looking for does not exist or you are unauthorized to view this page.
    </div>
    <hr>
